...
export default function ViewConfirmation() {
    ...
    return (
        <div
            className="flex items-center justify-center min-h-[calc(100vh-120px)] bg-gradient-to-br from-green-100 via-white to-blue-100">
            <div
                className="bg-white/90 backdrop-blur-md shadow-2xl rounded-2xl p-8 w-full max-w-md border border-green-100 scale-95">
                ...
                <div className="text-center mb-6">
                    <span className="font-semibold text-gray-800">Confirmation Number:</span>
