...
export default function ContactPage() {
  ...
  const faqs = [
    { q: "What is your typical response time?", a: "We reply within 1 business day (Monday–Friday, 9am–6pm ET)." },
    { q: "Do you offer phone support?", a: "Yes—phone support is available for Pro and Enterprise plans during business hours." },
    { q: "Where can I find my invoices?", a: "Invoices are available in your account's Billing section. Contact us if you need an updated receipt." },
    { q: "How do I report a security issue?", a: "Please email security@team8.com with details. We appreciate responsible disclosures." },
  ];
    ...
    <div className="min-h-[calc(100vh-200px)] bg-white">
      ...
      <section className="bg-gradient-to-b from-gray-50 to-white border-b">
        <div className="container mx-auto px-6 py-14">
          <h1 className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-700 to-purple-700 drop-shadow-sm">Contact Us</h1>
          <p className="mt-5 text-lg text-gray-700 max-w-2xl leading-relaxed">
            We're here to help. Browse quick answers below or send us a message—our team typically responds within one business day.
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <aside className="lg:col-span-1 space-y-6">
          <div className="border rounded-2xl p-6 shadow-sm">
            ...
            <p className="mt-2 text-gray-600">Our team is available Monday–Friday, 9am–6pm Eastern Time.</p>
            <div className="mt-4 space-y-3 text-gray-700">
              <div>
                <p className="text-sm uppercase tracking-wide text-gray-500">Email</p>
                <a href="mailto:support@team8.com" className="hover:underline break-all">support@team8.com</a>
              </div>
              <div>
              ...
              <div>
                ...
                <p>123 Market Street, Suite 456<br />New York, NY 10001</p>
              </div>
            </div>
          </div>

          <div className="border rounded-2xl p-6 shadow-sm">
            <h3 className="text-3xl font-bold text-indigo-700 mb-3">Hours & Status</h3>
            <ul className="mt-3 space-y-2 text-gray-600">
              <li>• Standard response: within 1 business day</li>
              <li>• Urgent outages: <a className="text-blue-600 hover:underline" href="#">status.team8.com</a></li>
              <li>• Knowledge base: <a className="text-blue-600 hover:underline" href="#">help.team8.com</a></li>
            </ul>
          </div>
        </aside>
        ...
        <div className="lg:col-span-2 space-y-8">
          {/* FAQ */}
          <div className="border rounded-2xl p-6 shadow-sm">
            <h3 className="text-3xl font-bold text-indigo-700 mb-3">Frequently Asked Questions</h3>
          ...
          {/* Contact Form */}
          <div className="border rounded-2xl p-6 shadow-sm">
            <h3 className="text-3xl font-bold text-indigo-700 mb-3">Send us a message</h3>
            {submitted ? (
